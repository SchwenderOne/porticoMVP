	...
	return (
		<div className="relative size-full" data-name="layers" data-node-id="10:446">
			...
			>
				...
				<div className="absolute" style={{ left: 14, top: 12, width: 20, height: 20 }} data-name="Group" data-node-id="10:450">
					<img alt="" className="block max-w-none size-full" src={imgGroup} />
				</div>
				<div className="absolute" style={{ left: 38, top: 12, width: 56, height: 20, color: '#343434', fontSize: 18, lineHeight: '20px', textAlign: 'left' }} data-node-id="10:449">
					Layers
				</div>
			</div>
		</div>
